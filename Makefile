...
product-revisi:
	./dist/import_tool product-revisi --file ./uploads/product.xlsx --dsn "root:@tcp(127.0.0.1:3306)/web_kebayoran_new?parseTime=true&multiStatements=true" --admin-id 1 --batch 500
...
invoice-return-product-outstanding:
	./dist/import_tool invoice-return-product-outstanding --file ./uploads/invoice-return-product-outstanding.xlsx --dsn "root:@tcp(127.0.0.1:3306)/web_kebayoran_new?parseTime=true&multiStatements=true" --batch 500
